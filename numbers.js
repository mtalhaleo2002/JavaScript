...
let b1 = parseInt('19', 10);
console.log(b1); // Output: 19
let b2 = parseInt('+19', 10);
console.log(b2); // Output: 19
let n3 = parseInt('-19', 10);
console.log(n3); // Output: -19
let n4 = parseInt('19 Grad', 10);
console.log(n4); // Output: 19
let n5 = parseInt('19.9', 10);
console.log(n5); // Output: 19
let n6 = parseInt('019', 10);
console.log(n6); // Output: 19
let n7 = parseInt(' 19', 10);
console.log(n7); // Output: 19
let n8 = parseInt('19abc', 10);
console.log(n8); // Output: 19
let n9 = parseInt('abc19', 10);
console.log(n9); // Output: NaN

function add(stringName) {
    let firstValue = parseInt(stringName, 10);
    let findIndex = stringName.indexOf('+');
    let AfterPlus = stringName.substr(findIndex + 1);
    let secondValue = parseInt(AfterPlus, 10);
...
// console.log(add("19+ 1"));
// console.log(add("19 +1"));
// console.log(add("19+1 Grad"));
// console.log(add("19 +1 Grad"));
// console.log(add("19+ 1 Grad"));
// These are all console works in Browser Console Or Online JavaScript Editors

// ParseInt Function and Addition from String